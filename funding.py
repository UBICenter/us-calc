...
def ubi(statefip, level, agi_tax, benefits, taxes, exclude):
    ...
    non_citizen_child_population = (target_persons.non_citizen_child * target_persons.asecwt).sum()
    ...
    x2=['Child', 'Adult', 'People<br>with<br>disabilities', 'White', 'Black', 'Hispanic']
                            ...
                            text=[child_poverty_rate_change,
                              ...
                              hovertemplate=['Original child poverty rate: ' + original_child_poverty_rate_string + '%<br><extra></extra>'
                                       'New child poverty rate: ' + child_poverty_rate_string + '%',
                                             'Original adult poverty rate: ' + original_adult_poverty_rate_string + '%<br><extra></extra>'
                                       'New adult poverty rate: ' + adult_poverty_rate_string + '%',
                                             'Original pwd poverty rate: ' + original_pwd_poverty_rate_string + '%<br><extra></extra>'
                                       'New pwd poverty rate: ' + pwd_poverty_rate_string + '%',
                                             'Original White poverty rate: ' + original_white_poverty_rate_string + '%<br><extra></extra>'
                                       'New White poverty rate: ' + white_poverty_rate_string + '%',
                                             'Original Black poverty rate: ' + original_black_poverty_rate_string + '%<br><extra></extra>'
                                       'New Black poverty rate: ' + black_poverty_rate_string + '%',
                                             'Original Hispanic poverty rate: ' + original_hispanic_poverty_rate_string + '%<br><extra></extra>'
